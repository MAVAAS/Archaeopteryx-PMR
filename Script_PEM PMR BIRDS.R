...
tree<-read.nexus("pmr1.trees.trees.trees.trees.trees.trees.trees.trees.trees.nex")
...
plot(NA,ylim=c(1L,length(tree2$tip.label)),xlim=lab,axes=FALSE,xlab="PMR (mLO2 h-1 g-0.94)")
lab <- lab[1L]:lab[2L]
